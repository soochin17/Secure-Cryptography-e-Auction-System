...
public class view_participated_auction_list extends javax.swing.JFrame {
    ...
    public view_participated_auction_list() {
        initComponents();
    ...
    public static ArrayList<auction> getAuction(){
        ...
        String qr2 = "SELECT `auctionID` FROM `bid` WHERE `bidderID`=?";
        ...
        try {
            ...
            //check for all the auctions that this bidder has participated
            ...
            for(int k=0; k<auctionID_arr.length; k++){
                try {
                    ...
                    Logger.getLogger(view_participated_auction_list.class.getName()).log(Level.SEVERE, null, ex);
                }
            }
    ...
    private void initComponents() {
        ...
        jScrollPane1.setPreferredSize(new java.awt.Dimension(800, 330));

        DefaultTableModel model = new DefaultTableModel();
        Object[] columnsName = new Object[5];
        columnsName[0] = "Auction ID";
        columnsName[1] = "Product Name";
        columnsName[2] = "Start Time";
        columnsName[3] = "Endtime";
        columnsName[4] = "Winning Price";
        ...
        for(int i=0; i<getAuction().size(); i++){
            ...
            rowData[2] = getAuction().get(i).getStartTime();
            rowData[3] = getAuction().get(i).getEndTime();
            rowData[4] = getAuction().get(i).getWinningPrice();
        ...
        jScrollPane1.setBounds(55, 90, 800, 340);
        ...
        jLabel3.setText("Bidder Panel - View My Participated Auctions");
        jPanel2.add(jLabel3);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new view_participated_auction_list().setVisible(true);
            }
        });
